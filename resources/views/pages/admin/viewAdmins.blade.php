            ...
            <div class="modal-body">
                <form id="editAdminForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="editAdminName" name="name" placeholder="Enter admin's name">
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-body">
                <form id="addAdminForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="adminName" name="name" placeholder="Enter admin's name">
                    </div>
                    <div class="mb-3">
